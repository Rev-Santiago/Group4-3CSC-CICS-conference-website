...
const PublicationPage = () => {
  return (
    <section className="mx-auto px-10 pb-10">
      {/* Title */}
      <h2 className="text-4xl mb-4">Publication</h2>

      {/* Conference Proceedings */}
      <h3 className="text-2xl text-customRed mb-2">Conference Proceedings</h3>
      ...
      <h3 className="text-2xl text-center mb-4">Previous Conference Publications</h3>
