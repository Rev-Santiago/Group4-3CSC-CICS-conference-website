        ...
        events: [
            {
                ...
                program: "Event Name\nSpeaker\nZoom or Google Link Redirection\nOther Details",
                icsFile: "#", // Replace with actual ICS file URL
            },
            {
                        ...
                        <table className="w-full border-collapse border border-black">
                            <thead>
                                <tr className="bg-customRed text-white">
                                    ...
                                    <th className="border border-black p-2">ICS File</th>
                                </tr>
                            </thead>
                            <tbody>
                                {day.events.map((event, i) => (
                                    <tr key={i} className="border border-black text-center">
                                        ...
                                        <td className="border border-black p-2">
                                            {event.icsFile !== "N/A" ? (
                                                <a href={event.icsFile} className="text-blue-500 underline">
                                                    Download ICS
                                                </a>
                                            ) : (
                                                "N/A"
